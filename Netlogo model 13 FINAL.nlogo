globals [
  ...
  numtents                ; number of tents in the simulation
...
to go-get-food2
  ...
  [set food-time (food-time + 1)
    if food-time > 20 [set food-time 6]]  ; if it's too late, the timer is set to the next day (this is a choice, it should be possible from the aid deliverers as well).
end
